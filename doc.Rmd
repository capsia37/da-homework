...
levels(BankChurners$Income_Category) <- c("120K+", "$40K - $60K", "$60K - $80K", "$80K - $120K",  "Less than $40K", "Unknown")
BankChurners$Income_Category <- factor(BankChurners$Income_Category, levels = c("Less than $40K", "$40K - $60K", "$60K - $80K", "$80K - $120K", "120K+", "Unknown"))
barplot(table(BankChurners$Income_Category), main= "Grafico a barre", xlab="Categoria", ylab="Frequenza")
...
plot(HousePrices$MSSubClass, HousePrices$SalePrice, main = "Grafico a dispersione", xlab = "MSSubClass",
     ylab = "Prezzo(target)")
...
correlation <- cor(HousePrices$MSSubClass, HousePrices$SalePrice, method="pearson")
correlation
...
# il grafico a barre:
boxplot(HousePrices$SalePrice~HousePrices$GarageType, main = "Media dei Prezzi per Tipo di Garage", xlab = "Tipo di Garage", 
...
plot(HousePrices$PoolArea, HousePrices$SalePrice, main = "Grafico a dispersione", xlab = "Piedi quadri",
     ylab = "Prezzo(target)")
...
plot(HousePrices$GarageCars, HousePrices$SalePrice, main = "Grafico a dispersione", xlab = "Capienza",
     ylab = "Prezzo(target)")
